...
export const Navbar = () => {
  return (
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          <NavigationMenuTrigger className="bg-gray-700 opacity-90 text-xs">GALLERY</NavigationMenuTrigger>
          <NavigationMenuContent>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger className="bg-gray-700 opacity-90 text-xs">OFFERS</NavigationMenuTrigger>
          <NavigationMenuContent>
        ...
        <NavigationMenuItem>
            <NavigationMenuLink className="text-xs font-medium bg-gray-700 opacity-90 underline underline-offset-4 decoration-transparent hover:decoration-gray-100 transition-colors duration-200 cursor-pointer">
              CONTACT US
            </NavigationMenuLink>
        </NavigationMenuItem>
      </NavigationMenuList>

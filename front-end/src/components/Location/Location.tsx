...
export const Location = () => {
  return (
    <section className="grid grid-rows-1 grid-cols-2 gap-y-4 items-center justify-center h-[75vh] bg-gray-100 px-4 py-12">
      <div className="relative border-l-2 border-gray-900 h-full flex items-center justify-center items-center w-full">
        ...
        <div className="absolute bottom-[48px] flex items-center  gap-x-8  ">
          ...
          <div className="flex gap-x-1" title="phone">

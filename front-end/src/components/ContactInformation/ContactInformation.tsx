...
export const ContactInformation = () => {
  ...
  return (
    <form
      ...
      className="grid grid-flow-row auto-rows-max gap-y-6"
    >
      <div className="flex items-center gap-x-6">
        <input
          ...
          type="text"
          placeholder="John"
          className="w-[300px] h-10 pl-2 py-6 border-transparent outline-none focus:ring-2 focus:ring-teal-700 rounded-sm"
        />
        {errors.firstName && (

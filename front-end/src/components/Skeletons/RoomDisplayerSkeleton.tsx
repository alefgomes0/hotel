export const RoomDisplayerSkeleton = () => {
  return (
    <div className="grid grid-rows-1 grid-cols-[auto_1fr] border-2 border-gray-300 gap-x-12 rounded-sm p-4 mt-4 mb-10">
      ...
      <div className="flex flex-col gap-y-3">
        ...
        <div className="w-16 h-4 bg-[#c7c7c7] animate-pulse rounded-sm pt-3"></div>
        <div className="pt-3">

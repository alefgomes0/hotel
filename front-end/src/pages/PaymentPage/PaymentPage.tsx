...
export const PaymentPage = () => {
  ...
  return (
    <main className="relative grid xl:grid-cols-[3fr_1fr] xl:grid-rows-[auto_1fr] min-h-[calc(100svh-90px)] gap-x-6 text-gray-700 bg-gray-100 px-4 xl:px-16 pt-4 xl:pt-20">

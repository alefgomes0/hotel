...
export const ConfirmReservation = () => {
  return (
    <main className="static xl:relative grid grid-cols-1 grid-cols-1 xl:grid-cols-[3fr_1fr] auto-rows-max gap-x-6 min-h-[calc(100svh-90px)] text-gray-700 bg-gradient-to-b from-slate-100 to-slate-300 px-4 xl:px-16 pt-12 pb-8 lg:pb-0">
